...
A research from [Bankrate](https://www.bankrate.com/personal-finance/side-hustles-survey/) seems to support it:
...
A research from [World Health Organization](https://www.who.int/news/item/17-05-2021-long-working-hours-increasing-deaths-from-heart-disease-and-stroke-who-ilo) found that working more than 55 hours per week is associated with:
...
A research from [American Psychological Association](https://www.apa.org/news/press/releases/stress) shows:
...
A research from [Centers for Disease Control](https://www.cdc.gov/sleep/data-and-statistics/adults.html) calls sleep deprivation a public health epidemic. But hustle culture calls it dedication.
...
A research from [Stanford University](https://docs.iza.org/dp8129.pdf) found that productivity per hour declines sharply when a person works more than 50 hours per week. After 55 hours, productivity drops so much that working more hours accomplishes nothing.
...
A research from [Economic Policy Institute](https://www.epi.org/productivity-pay-gap/) found that while worker productivity has increased **61.8%** since 1979, hourly compensation has only risen **17.5%**.
